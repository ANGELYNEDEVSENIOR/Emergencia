...
import Modelo.Factory.FactoryEmergencias;
...
SistemaEmergencias sistema = SistemaEmergencias.getInstancia();
        ...
        while (!salir) {
            System.out.println("\n=== SISTEMA DE ATENCION A EMERGENCIAS ===");
...
//            }
            ...
            switch (opcion) {
                case 1:
                    System.out.println("Registrando una nueva emergencia...");
                    registrarEmergenciaMenu(sistema, sc);
                    break;
                case 2:
                    System.out.println("El estado de losrecursos disponibles son:");
                    sistema.mostrarEstadoRecursos();
                    break;
                case 3:
                    System.out.println("Estamos atendiendo la emergencia...");
                    atenderEmergenciaMenu(sistema, sc);
                    break;
                case 4:
                    System.out.println("Las estadísticas del dia son:");
...
private static void inicializarRecursosDemo(SistemaEmergencias sistema) {
    // Inicializar recursos y para ello creamos la lista de recursos
